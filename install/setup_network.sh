...
sudo nmcli con add type wifi ifname wlan0 con-name "Car_Hotspot" ssid "$HOTSPOT_SSID" mode ap wifi-sec.key-mgmt wpa-psk wifi-sec.psk "$HOTSPOT_PASS" connection.autoconnect no
